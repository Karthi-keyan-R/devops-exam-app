...
pipeline {
    ...
    environment {
        DOCKER_IMAGE = "karthi91keyan/devopsexamapp:latest"
    }

    stages {
        stage('Git Checkout') {
            steps {
                git url: 'https://github.com/Karthi-keyan-R/devops-exam-app.git', 
                    branch: 'master'
            }
        }
...
pipeline {
    ...
    environment {
        DOCKER_IMAGE = "karthi91keyan/devopsexamexamapp:latest"
    }
